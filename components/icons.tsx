...
export const ShirtIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.5 7l-1.5-1.5-3 3-3-3L8.5 7M12 18.5V13M4.5 8.5L6 10l-1.5 1.5M19.5 8.5L18 10l1.5 1.5M6 13h12v7H6v-7z" />
  </svg>
);
...
export const SaveIcon: React.FC<{ className?: string }> = ({ className = "h-5 w-5 mr-2" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
